...
namespace XamarinAllianceApp.Helpers
{
    public class Constants
    {
        ...
        public static readonly string MobileServiceAuthentication = "https://xamarinalliancesecurebackend.azurewebsites.net";
        public static readonly string StorageAccountURL = "https://xamarinalliance.blob.core.windows.net";
        public static readonly string XamarinAllianceURL = "https://xamarinalliance.blob.core.windows.net/images/XAMARIN-Alliance-logo.png";
    }
}
